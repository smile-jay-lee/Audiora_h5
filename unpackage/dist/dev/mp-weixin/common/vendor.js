...
function initRuntimeSocketService() {
  const hosts = "172.20.32.1,192.168.56.1,192.168.137.1,192.168.81.1,192.168.132.186,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin__uWUg4";
...
function setConfig({
  ...
  index$1.$uv.props = deepMerge2(index$1.$uv.props, props);
