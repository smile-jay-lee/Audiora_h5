...
const _sfc_main = {
  ...
  methods: {
        ...
        success: (res) => {
          if (res.tapIndex === 0) {
            common_vendor.index.chooseMedia({
              ...
              fail: (err) => {
                common_vendor.index.__f__("log", "at components/upload.vue:252", "选择文件失败:", err);
            ...
            common_vendor.index.chooseMedia({
              ...
              fail: (err) => {
                common_vendor.index.__f__("log", "at components/upload.vue:271", "拍摄失败:", err);
                this.$refs.toast.show({
                  title: "拍摄失败",
                  type: "error"
                });
    ...
    handleFileSelect(file) {
      common_vendor.index.__f__("log", "at components/upload.vue:285", "选择的文件:", file);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    D: common_vendor.sr("toast", "0eb8546b-2")
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0eb8546b"]]);
